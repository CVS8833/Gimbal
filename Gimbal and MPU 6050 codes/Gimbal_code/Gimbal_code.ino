/*
  ...
  Also acknowledgement to "How to Mechatronics" for MPU 6050 tutorial
*/

//Necessary Libraries to be included
#include "I2Cdev.h"
...
#define INTERRUPT_PIN 2 //Interrupt pin is D2 on Arduino Nano and Uno
